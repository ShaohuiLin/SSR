...
def net(inputs, num_classes, weight_decay=None, is_training=False):
    ...
    x = AULMConv2d(20, (5, 5), activation='relu', padding='valid', name='conv1', kernel_regularizer=regularizers.l2(weight_decay), Lambda=0.4)(inputs)
    x = MaxPooling2D((2, 2), strides=(2, 2), name='pool1')(x)
    x = Conv2D(50, (5, 5), activation='relu', padding='valid', name='conv2', kernel_regularizer=regularizers.l2(weight_decay))(x)
    x = MaxPooling2D((2, 2), strides=(2, 2), name='pool1')(x)
